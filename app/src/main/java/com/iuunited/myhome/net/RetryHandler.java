...
class RetryHandler implements HttpRequestRetryHandler {
    ...
    static {
        ...
        exceptionWhitelist.add(HttpHostConnectException.class);
        exceptionWhitelist.add(ConnectionPoolTimeoutException.class);
    ...
    public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
        ...
        if (retry) 
        {
            ...
            Log.i("AsyncHttpRequest", " request meet except_type:" + exception.getClass().toString() +", except:"+exception.getMessage() + ", retry:"+(currentReq != null));
