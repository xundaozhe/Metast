package com.iuunited.myhome.net;
...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                Log.i("AsyncHttpRequest", "AbstractHttpClient HttpRequestInterceptor process...");
            }
        });
    ...
    {
    	return HttpProtocolParams.getUserAgent(this.httpClient.getParams());
    }
...
//    	httpclient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, 60000);
    	...
    	int retrySleepTimeMS = 3000;
        this.httpClient.setHttpRequestRetryHandler(new RetryHandler(retries, retrySleepTimeMS));
    }
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        ...
        //Log.i("AsyncHttpRequest", "sendRequest:"+uriRequest.getURI());
        ...
        Log.i("AsyncHttpRequest", "sendRequest submited");
