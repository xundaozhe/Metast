...
public class GaoDeMapActivity extends Activity implements LocationSource,AMapLocationListener, View.OnClickListener,PoiSearch.OnPoiSearchListener, AMap.OnMarkerClickListener, AMap.InfoWindowAdapter {
...
//        aMap.setMyLocationStyle(AMap.loca);
...
//                markerOptions.position(new LatLng(aMapLocation.getLatitude(), aMapLocation.getLatitude()));
...
//                aMap.addMarker(markerOptions);
    ...
    private void search(){
        ...
        Log.i("---", keyWord);
        if ("".equals(keyWord)){
            Toast.makeText(GaoDeMapActivity.this, "请输入搜索关键字",Toast.LENGTH_SHORT).show();
            return;
        }else {
            doSearchQuery();
        }
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        Toast.makeText(GaoDeMapActivity.this, infomation,Toast.LENGTH_SHORT).show();
    ...
    public void onPoiSearched(PoiResult poiResult, int i) {
        ...
        if (i == 1000) {
            ...
            if (poiResult != null && poiResult.getQuery() != null) {// 搜索poi的结果
                ...
                Toast.makeText(GaoDeMapActivity.this, "该距离内没有找到结果",Toast.LENGTH_SHORT).show();
            }
        } else {
            Log.i("---","查询结果:"+i);
            Toast.makeText(GaoDeMapActivity.this, "异常代码---"+i,Toast.LENGTH_SHORT).show();
        }
